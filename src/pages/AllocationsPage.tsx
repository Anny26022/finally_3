...
import { calcAllocationPercentage } from '../lib/calculations';
...
const AllocationsPage: React.FC = () => {
    ...
    const topAllocations = useMemo(() => {
        ...
        // Calculate allocation for each open/partial trade using centralized function
        ...
        const tradesWithAllocation = openAndPartialTrades.map(trade => {
            ...
            if (portfolioSize > 0) {
                if (trade.positionStatus === 'Partial') {
                    ...
                    calculatedAllocation = calcAllocationPercentage(remainingInvestedAmount, portfolioSize);
                } else {
                    // For fully open positions, use full position size
                    calculatedAllocation = calcAllocationPercentage(trade.positionSize || 0, portfolioSize);
                }
            }
            return {
                ...trade,
